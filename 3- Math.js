/* // .MATH 
    ...
    Oq é o.Math ?
    "é um objeto embutido dentro do js que tem propriedades e métodos para constantes e funções matemáticas."

    alguns exemplos de.Math:

console.log(Math.PI) //Mostra o valor de pi
console.log(Math.pow(2, 2)) //Pow ou Power = potênciação
console.log(Math.sqrt(25, 2)) // permite calcular a Raiz quadrada 
console.log(Math.random()) // Mostra um numero aleatorio entre 0 e 1
console.log(Math.ceil(23.6)) // Arredonda um numero acima
console.log(Math.floor(23.6)) // Arredonda para baixo
